...
- **Luo, H.** A UVC Purifier for Improving IAQ in Building Environment. Patent No: ZL 2013 3 0320199.2
- **Luo, H.** Indoor Air Purification Device. Patent No: ZL 2013 2 0094064.3 (Authorized)
...
- Used NeurIPS 2022 CityLearn Challenge dataset (17 buildings in California) as virtual testbed
- Achieved **13% improvement** over baseline performance
...
- Performed finite element analysis of aeroelastic models and turbulent flow field simulations
- Completed wind tunnel tests for:
  - 🌉 **1915 Çanakkale Bridge**, Turkey (World's longest suspension bridge)
  - 🏙️ Shanghai Lujiazui Financial Trade Zone skyscraper cluster
...
- Conducted microclimate analysis using EnergyPlus, Ecotect, and SketchUp
- 🏆 Won **5th International BIM Award** and **2020 Bentley Excellence Award**
